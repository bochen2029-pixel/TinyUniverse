...
| **fluidcss_nexus** | C++17 fp64 | **Axis-C crown, Stage-A**: Evans–Coleman radiation-fluid CSS critical background (oi\*=3/8 exact, sonic point (3/2, 2/√3, 3/4, −1/√3), 2m/r=1/3) — the fluid-β foundation stone | HKA gr-qc/9607010 §IV | exact EC invariants + sonic values (~1e-5), grid-convergent 3.8e-6 | **Stage-A FROZEN — golden `b4f4e463` (D-027). Stage-B β=0.35580192: honest wall — operator PROVEN correct (D-031), extraction method walled; next = HKA Lyapunov §V.G** |
