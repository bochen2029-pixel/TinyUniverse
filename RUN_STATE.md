...
2. **#4 · crown research** — **fluid-β Stage-A ✅ BANKED** (`substrate/fluidcss_nexus.cpp` v0.9.1, golden `fluidcss_stageA` `b4f4e463`: Evans–Coleman background — oi*=3/8, sonic point + 2m/r=1/3 EXACT, invariants + grid-converge green; D-027). *Remaining walls:* fluid-β Stage-B (the HKA perturbation ∂ₛ coupling — β not faked) · scalar-γ = 0.374 (DSS, G97 gr-qc/9604019).
