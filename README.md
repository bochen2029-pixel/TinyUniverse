...
**Status:** v1 milestones **M0–M7 complete** · v2 substrate ladder **N0–N3 complete** — with the lapse (N2) and curved geometry (N3), **all four classical tests of GR pass on the substrate's own metric** (redshift · light-bending · precession · Shapiro) — plus the 2.5PN inspiral oracle, the Q-006 precession resolution, and the **fluid-CSS critical-exponent crown — β measured** (0.3557988 vs the literature's 0.35580192, on the true Evans–Coleman background, D-032). **40/40 goldens green** (full suite re-verified cold 2026-07-19; the two crown goldens two-passed same day). Built on a shared, sibling GPU with a 4070 Ti SUPER (16 GB), CUDA 13.1, `sm_89`.
